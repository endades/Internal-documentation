...
Is important to recognise that easily to take measures, like for example, buy materials or assign materials.
    ...
    <strong style="color:#1B0FA3;font-weight:1200;background:linear-gradient(transparent 60%, #C9CCFF 60%);">Front-end</strong>
    ...
    <strong style="color:#1B0FA3;font-weight:1200;background:linear-gradient(transparent 60%, #C9CCFF 60%);">Back-end</strong>
